...
1. Open [`notebooks/gradio_colab_launcher.ipynb`](../../notebooks/gradio_colab_launcher.ipynb) in Google Colab.
...
settings = AppSettings(
    ...
    config_path=Path("../../packages/envira_pdf_layout/config/default.yaml"),
)
...
- `envira_pdf_layout`: canonical layout detection, post-processing, export, and validation dependency.
- `config/`: application-specific Colab profile; canonical defaults live in the pipeline package.
