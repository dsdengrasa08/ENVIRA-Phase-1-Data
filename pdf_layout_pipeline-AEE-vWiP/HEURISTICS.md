...
| Page-1 metadata structure | Normalize heading and group field values | populated field labels, local reading order, alignment, adaptive line gaps, and semantic boundaries | scholarly structure and language lexical | no | two populated fields for container headings, same-field-only grouping, column/body/field barriers, source provenance, retain-on-ambiguity |
