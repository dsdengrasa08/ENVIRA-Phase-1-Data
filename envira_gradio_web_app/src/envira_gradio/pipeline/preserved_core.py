...
def run_preserved_core(conversion, page_set, config) -> PipelineResult:
    ...
    with _PRESERVED_CORE_LOCK, _temporary_environment(environment):
        ...
        region_conversion_diagnostics = {
            ...
            "implementation": "envira_gradio.pipeline.region_conversion",
        }
        ...
        from .roi_ocr import RoiOcrError, RoiOcrSession
    ...
    diagnostics = {
        ...
        "implementation": "envira_gradio.pipeline.preserved_core",
    }
