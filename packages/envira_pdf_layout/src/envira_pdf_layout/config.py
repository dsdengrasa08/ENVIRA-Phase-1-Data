...
class RuntimeConfig:
    ...
    local_cache_root: Path = Path(".cache/envira")
    offline: bool = False
...
class FigureFilterConfig:
    ...
    refinement_min_component_area_ratio: float = 0.00005
    refinement_min_conflict_smaller_ratio: float = 0.08
    refinement_min_penetration_page_ratio: float = 0.004
    refinement_max_neighbor_gap_page_ratio: float = 0.002
    refinement_min_cross_axis_overlap_ratio: float = 0.25
